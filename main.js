...
function init() {
    ...
    function gameOver() {
        ...
        if (player.y > height / 2 && flag === 0) {
            ...
            tweet.href = 'http://twitter.com/share?url=http://goo.gl/L5D25V&text=I just scored ' + score + ' points in Pikachu\'s Jump Quest&hashtags=pikachu,pokemon,pikachusjumpquest&via=schme16';

            var facebook = document.getElementById("fbBtn");
            facebook.href = 'http://facebook.com/sharer.php?m2w&s=100&p[url]=http://goo.gl/L5D25V&p[title]=I just scored ' + score + ' points in Pikachu\'s Jump Quest!&p[summary]=Can you beat my awesome score in Pikachu\'s Jump Quest?';
...
function setUpTracking(){
  ...
  analytics.sendAppView('home', function(){console.log('Tracking Success')}, function(){console.log('Tracking Failure')});
}
